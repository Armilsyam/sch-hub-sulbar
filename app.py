...
# ==========================================
    ...
    with tab_pasar1:
        ...
        st.writer("WILAYAH POLEWALI MANDAR")
        ...
        st.writer("WILAYAH MAMUJU TENGAH")
